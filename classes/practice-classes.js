...
class Player extends Character {
  ...
  // defend(opponentAttackLevel){
  //   let  this.healthLevel  
  //   if(this.healthLevel > 3){
  //     return {
  //       attackStrength: this.attackLevel,
  //       remainingHealth: this.healthLevel - this.attackLevel,
...
class Hero extends Player{
  ...
  // }
  // useSuperPower(index){
  //   this.superPowers.splice(index, 1, `${this.name} used ${this.superPower[index]}`)
  // }
...
let fireSpitter = new Player("Fire Spitter", "dragon", 5000, 5000)
fireSpitter.addSuperPowers("spitting fire", "kickin ass", 'takin names')
